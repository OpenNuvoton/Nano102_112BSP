...
void SYS_Init(void)
{
    ...
    SYS->PA_L_MFP &= ~(SYS_PA_L_MFP_PA0_MFP_Msk | SYS_PA_L_MFP_PA1_MFP_Msk | SYS_PA_L_MFP_PA2_MFP_Msk | SYS_PA_L_MFP_PA3_MFP_Msk);
    SYS->PA_L_MFP |= SYS_PA_L_MFP_PA0_MFP_ADC_CH0 | SYS_PA_L_MFP_PA1_MFP_ADC_CH1 | SYS_PA_L_MFP_PA2_MFP_ADC_CH2 | SYS_PA_L_MFP_PA3_MFP_ADC_CH3;

    /* Disable PA.0 PA.1 PA.2 PA.3 digital input path */
    PA->OFFD = PA->OFFD | (((1<<0) | (1<<1) | (1<<2) | (1<<3)) << GP_OFFD_OFFD_Pos);
