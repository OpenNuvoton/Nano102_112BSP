...
/** @addtogroup NANO1X2_SCLIB Smartcard Library
  @{
*/

/** @addtogroup NANO1X2_SCLIB_EXPORTED_CONSTANTS Smartcard Library Exported Constants
  @{
*/
...
/*@}*/ /* end of group NANO1X2_SCLIB_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NANO1X2_SC_Library */
