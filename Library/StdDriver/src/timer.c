...
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
    ...
    if(timer == TIMER0)
    {
        ...
        u32Div = (CLK->CLKDIV1 & CLK_CLKDIV1_TMR0_N_Msk) >> CLK_CLKDIV1_TMR0_N_Pos;
    }
    else if(timer == TIMER1)
    {
        u32Src = (CLK->CLKSEL1 & CLK_CLKSEL1_TMR1_S_Msk) >> CLK_CLKSEL1_TMR1_S_Pos;
        u32Div = (CLK->CLKDIV1 & CLK_CLKDIV1_TMR1_N_Msk) >> CLK_CLKDIV1_TMR1_N_Pos;
    }
    else if(timer == TIMER2)
    {
        u32Src = (CLK->CLKSEL2 & CLK_CLKSEL2_TMR2_S_Msk) >> CLK_CLKSEL2_TMR2_S_Pos;
        u32Div = (CLK->CLKDIV1 & CLK_CLKDIV1_TMR2_N_Msk) >> CLK_CLKDIV1_TMR2_N_Pos;
    }
    else    // Timer 3
    {
        u32Src = (CLK->CLKSEL2 & CLK_CLKSEL2_TMR3_S_Msk) >> CLK_CLKSEL2_TMR3_S_Pos;
        u32Div = (CLK->CLKDIV1 & CLK_CLKDIV1_TMR3_N_Msk) >> CLK_CLKDIV1_TMR3_N_Pos;
    }
    u32Div++;
    if(u32Src < 4)
